            ...
            <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <tr>
                ...
                <td>
                  <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                      <button class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick="editRow(this)"><span class="am-icon-pencil-square-o"></span> 编辑</button>
...
<script src="assets/js/moditable.js"></script>
</body>
</html>
