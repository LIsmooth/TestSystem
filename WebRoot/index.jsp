      ...
      <ul class="am-list admin-sidebar-list">
        ...
        <li class="admin-parent">
          ...
          <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
            <li><a href="questionAdd.jsp" class="am-cf"><span class="am-icon-check"></span>题库增加页<span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span></a></li>
            <li><a href="admin-help.html"><span class="am-icon-puzzle-piece"></span> 题库删除页</a></li>
            <li><a href="questionUpdate.jsp"><span class="am-icon-th"></span> 题库修改页</a></li>
            <li><a href="questionShow.jsp"><span class="am-icon-calendar"></span> 题库查看页</a></li>
          </ul>
          ...
          <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
            <li><a href="questionAdd.jsp" class="am-cf"><span class="am-icon-check"></span>试卷增加页<span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span></a></li>
            <li><a href="admin-help.html"><span class="am-icon-puzzle-piece"></span> 试卷删除页</a></li>
            <li><a href="questionUpdate.jsp"><span class="am-icon-th"></span> 试卷修改页</a></li>
            <li><a href="questionShow.jsp"><span class="am-icon-calendar"></span> 试卷查看页</a></li>
          </ul>
          ...
          <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
            <li><a href="questionAdd.jsp" class="am-cf"><span class="am-icon-check"></span>查看历史成绩<span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span></a></li>
            <li><a href="admin-help.html"><span class="am-icon-puzzle-piece"></span>成绩浏览</a></li>
          </ul> 
          
          
          
           <a class="am-cf" data-am-collapse="{target: '#collapse-nav'}"><span class="am-icon-file"></span>阅卷<span class="am-icon-angle-right am-fr am-margin-right"></span></a>   
