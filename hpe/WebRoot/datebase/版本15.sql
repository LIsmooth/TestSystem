...
prompt Created on 2016年10月10日 by CK
set feedback off
set define off
...
insert into ESSAYQUESTION (subjectid, questionno, question, rightanswer, questionlevel, sectionid, isessay, questionmark)
values ('2', 50, '1', '123124124', 1, 1, 3, 25);
insert into ESSAYQUESTION (subjectid, questionno, question, rightanswer, questionlevel, sectionid, isessay, questionmark)
values ('1', 8, 'java语言的优点？', '跨平台', 1, 1, 4, 12);
insert into ESSAYQUESTION (subjectid, questionno, question, rightanswer, questionlevel, sectionid, isessay, questionmark)
values ('1', 29, '1+1=?', '2', 1, 4, 3, 3);
insert into ESSAYQUESTION (subjectid, questionno, question, rightanswer, questionlevel, sectionid, isessay, questionmark)
values ('6', 28, '123asdasd', '123123124235235', 2, 1, 3, 10);
commit;
...
insert into STUDENT (sno, sname, major, classid, sphone, spwd, sidcard, sex, spare)
values ('10010', '张三', 'JAVA', '1', '13013013010', '111', '123456789123456789', '男', null);
insert into STUDENT (sno, sname, major, classid, sphone, spwd, sidcard, sex, spare)
