    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding am-padding-bottom-0">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">题库修改</strong></div>
            </div>
            ...
            <div class="am-g">
                ...
                <form action="QuestionServlet" method="post" id="questionADD">
                	<input type="hidden" value="UPDQUES" name="op">
                	<input type="hidden" value="${MQ.questionno }" name="questionno">
                	<input type="hidden" value="${MQ.ismultiple }" name="oldQuestionType">
                    <table border="0" cellspacing="10" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <td><textarea name="subjectTitle" id="subjectTitle" cols="76" rows="5">${MQ.question }</textarea></td>
                        </tr>
                        <tr class="multiAnswer">
                            <td>选项A:</td>
                            <td><input type="text" name="questionA" id="questionA" size="20" value="${MQ.questionA }"></td>
                        </tr>
                        <tr class="multiAnswer">
                            <td>选项B:</td>
                            <td><input type="text" name="questionB" id="questionB" size="20" value="${MQ.questionB }"></td>
                        </tr>
                        <tr class="multiAnswer">
                            <td>选项C:</td>
                            <td><input type="text" name="questionC" id="questionC" size="20" value="${MQ.questionC }"></td>
                        </tr>
                        <tr class="multiAnswer">
                            <td>选项D:</td>
                            <td><input type="text" name="questionD" id="questionD" size="20" value="${MQ.questionD }"></td>
                        </tr>
                        <tr>
                            <td valign="top">答案:</td>
                            <td class="multiQuestion">
                                <input class="rightanswer" name="rightanswer" type="radio" value="A">A
                        ...
                        <tr>
                            <td>分值:</td>
                            <td><input type="text" name="questionmark" id="questionmark" value="${MQ.questionmark }"/></td>
                        </tr>
                        <tr>
                            <td colspan="2"><div align="center">
                                <input type="button" value="保存" onclick="checkAll()">
                                <a href="questionManage.jsp"><input type="button" value="返回"></a>
                            </div>
                            </td>
                        </tr>
                    </table>
...
<script>
	...
	window.onload=function(){
  		...
  		var rightanswer=document.getElementsByName("rightanswer");
  		var str1="${MQ.subjectid }";
  		var str2="${MQ.sectionid }";
  		var str3="${MQ.ismultiple }";
  		var str4="${MQ.questionlevel }";
  		var str5="${MQ.rightanswer }";
  		...
  		if(str3==1){
  			for(var i=0;i<rightanswer.length;i++){
  				if(rightanswer[i].value==str5){
  					rightanswer[i].checked=true;
  				}
  			}
  		}
  		if(str3==2){
            for(var i=0;i<rightanswer.length;i++){
            	rightanswer[i].type="checkbox";
  				if(str5.indexOf(rightanswer[i].value)>=0){
  					rightanswer[i].checked=true;
  				}
  			}
        }
