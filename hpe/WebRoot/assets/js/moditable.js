...
function editRow(obj){
        var editRow=obj.parentNode.parentNode.parentNode.parentNode;
        var editCols=editRow.cells;
        var txt1=editCols[2].innerText;
    ...
    function saveRow(obj){
        var saveRow=obj.parentNode.parentNode.parentNode.parentNode;
        var saveCols=saveRow.cells;
        var txt1=saveCols[2].firstElementChild.value;
        saveCols[2].innerText=txt1;
