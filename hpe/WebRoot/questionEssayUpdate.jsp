        ...
        <div class="admin-content-body">
            ...
            <div class="am-g">
                ...
                <form action="QuestionServlet" method="post" id="questionADD">
                	...
                	<input type="hidden" value="${EQ.questionno }" name="questionno">
                    <input type="hidden" value="${MQ.isessay }" name="oldQuestionType">
                    <table border="0" cellspacing="10" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <td><textarea name="subjectTitle" id="subjectTitle" cols="76" rows="5">${EQ.question }</textarea></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="essayQuestion">
                                <textarea class="rightanswer" name="essayRightanswer" id="rightanswer" cols="76" rows="3">${EQ.rightanswer }</textarea>
                            </td>
                        </tr>
                        <tr>
                            <td>难度等级:</td>
                        ...
                        <tr>
                            <td>分值:</td>
                            <td><input type="text" name="questionmark" id="questionmark" value="${EQ.questionmark }"/></td>
                        </tr>
                        <tr>
                            <td colspan="2">
                            <div align="center">
...
window.onload=function(){
        ...
        var multiAnswer=document.getElementsByClassName("multiAnswer");
  		var str1="${EQ.subjectid }";
  		var str2="${EQ.sectionid }";
  		var str3="${EQ.isessay }";
  		var str4="${EQ.questionlevel }";
